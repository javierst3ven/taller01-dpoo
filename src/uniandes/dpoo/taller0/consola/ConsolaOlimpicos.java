...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		// taller 01:
		System.out.println("13. Consultar el nombre del pais al que un atleta representa");
	...
	/*
	 * Ejecuta la opción para consultar el nombre del pais al que representa un atleta:
	 */
	private void ejecutarBuscarPaisJugador() {
		System.out.println("\nPais al que representa un atleta\n");
		
		// toLowerCase ya que todos los nombres de los jugadores se encuentran en minuscula
		String name = input("Ingrese el nombre del atleta: ").toLowerCase();
		String pais = calculadora.buscarPaisAtleta(name);
		
		System.out.println("El pais al que representa el atleta es: " + pais);
	}
	...
	private void ejecutarCargarAtletas()
	{
		...
		System.out.println("El programa realiza lo siguiente:");
		System.out.println("[*] Ya se encuentra en el directorio (./data/)");
		System.out.println("[*] Agrega la extensión (.csv)");
