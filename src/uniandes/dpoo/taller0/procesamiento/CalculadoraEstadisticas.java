...
public class CalculadoraEstadisticas
{
	...
	/**
	 * Busca el nombre del pais al que representa el atleta ingresado por parametro.
	 * 
	 * @param nombreAtleta El nombre del atleta.
	 * @return Retorna un String con el nombre del pais al que representa el atleta.
	 */
